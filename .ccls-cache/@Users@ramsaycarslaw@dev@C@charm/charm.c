...
void editorSetMark() {
  E.markx = E.cx;
  E.marky = E.cy;
  E.mark_coloff = E.coloff;
  E.mark_rowoff = E.rowoff;
...
void editorProcessKeypress() {
  ...
  case CTRL_KEY('u'):
    E.cx = E.markx;
    E.cy = E.marky;
    E.mark_rowoff = E.mark_rowoff;
    E.coloff = E.mark_rowoff;
...
int main(int argc, char *argv[]) {
 ...
 editorSetStatusMessage("Charm: C-q = quit | C-x = save | C-f = find | C-c = change");
